...
weight_pth = "C:\\Repos\\Ayrapetov\\07_AI_project\\04_segment\\01_Ultralytics\\runs\\segment\\5_Sewerage_red_pipe\\weights\\best.pt"
...
def pipe_add():
    ...
    for r in results:
        ...
        im.save(f'result/5_Sewerage_red_pipe/{image_name}')
